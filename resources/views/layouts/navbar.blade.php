    ...
    <div class="navbar_container">
        <div class="navbar_content">
            ...
            <div class="contain_navbar_redirections">
                ...
                <x-btn-primary text="{{Auth::check() ? 'Profile' : 'Sign-in' }}" icon='<i class="fa-solid fa-arrow-right-long"></i>' to="/{{ Auth::check() ? 'profile' : 'sign-in' }}" background="true"/>
            </div>
        ...
        <div class="navbar_burger_content">
            <a href="/" tabindex="-1" class="hover-effect">Home</a>
            ...
            <x-btn-primary text="{{Auth::check() ? 'Profile' : 'Sign-in' }}" icon='<i class="fa-solid fa-arrow-right-long"></i>' to="/{{ Auth::check() ? 'profile' : 'sign-in' }}"/>
        </div>
    </div>
</nav>
